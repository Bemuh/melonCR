...
export default function Diagnoses({
  ...
  const [finalidad, setFinalidad] = useState(
    encounter.finalidad_consulta || ""
  );
  const [causa, setCausa] = useState(
    encounter.causa_externa || ""
  );
  ...
  // ------- Autocomplete dataset (lazy-loaded, works in exe) -------
